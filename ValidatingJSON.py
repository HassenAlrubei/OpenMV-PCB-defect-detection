...
training_labels = 'C:/Users/admin/Documents/3rd Year project/OpenMV/PCB_DATASET/Train Valid Test/valid/labels'
main_dict = {}
...
for file in os.scandir(training_labels):
    if file.is_file():
        ...
        new_intra_files_dict['category'] = "Validating" # change for testing & validating
...
with open("valid_labels.json", "w") as out_train:
